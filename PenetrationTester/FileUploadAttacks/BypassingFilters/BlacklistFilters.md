...
## Questions
1. Try to find an extension that is not blacklisted and can execute PHP code on the web server, and use it to read "/flag.txt" **Answer: HTB{1_c4n_n3v3r_b3_bl4ckl1573d}**
