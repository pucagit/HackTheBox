...
## Files
One core principle of Linux is that everything is a file. We should look for, find, and inspect several categories of files one by one. These categories are the following:
- Configuration files
- Databases
- Notes
- Scripts
...
masterofblafu@htb[/htb]$ ls -la /etc/cron.*/
